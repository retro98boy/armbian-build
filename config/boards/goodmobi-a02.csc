# Amlogic A311D 4GB RAM 64GB eMMC FE Switch USB3 Hub
BOARD_NAME="GOODMOBI A02"
BOARD_VENDOR="goodmobi"
BOARDFAMILY="meson-g12b"
BOARD_MAINTAINER="retro98boy"
INTRODUCED="2026"
BOOTCONFIG="goodmobi-a02_defconfig"
KERNEL_TARGET="current,edge"
KERNEL_TEST_TARGET="current"
MODULES_BLACKLIST="simpledrm" # SimpleDRM conflicts with Panfrost on the GOODMOBI A02
FULL_DESKTOP="yes"
SERIALCON="ttyAML0"
BOOT_LOGO="desktop"
BOOT_FDT_FILE="amlogic/meson-g12b-a311d-goodmobi-a02.dtb"
...
function post_uboot_custom_postprocess__repack_vendor_fip_with_mainline_uboot() {
	...
	run_host_command_logged dd \
		if="${SRC}/cache/sources/amlogic-fip-blobs/goodmobi-a02/mmcblk0boot0" \
		of="${TMP_DIR}/fip" \
...
function post_family_tweaks_bsp__goodmobi-a02() {
